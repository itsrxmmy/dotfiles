...
Plug 'https://github.com/andweeb/presence.nvim' " Discord RPC
Plug 'https://github.com/tpope/vim-endwise' " Auto close structures
Plug 'https://github.com/jiangmiao/auto-pairs' " Auto close pairs
Plug 'https://github.com/tpope/vim-eunuch' " Vim helper tools
Plug 'https://github.com/morhetz/gruvbox' " Gruvbox theme
Plug 'https://github.com/ellisonleao/gruvbox.nvim' " Gruvbox lua port
Plug 'https://github.com/jbyuki/instant.nvim' " Neobim Live Share
" Plug 'https://github.com/Yggdroot/indentLine' " Show indent lines
